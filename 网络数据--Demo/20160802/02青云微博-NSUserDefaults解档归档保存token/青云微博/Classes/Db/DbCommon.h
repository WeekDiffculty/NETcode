...
//创建表
#define CreateTable @"CREATE TABLE if not exists WBHome (idstr text,CreatedAt text,\"Text\" text,Source text,favorited integer,user blob,retweetedStatus blob,repostsCount integer,commentsCount integer,attitudesCount integer,PicUrls blob)"
//向WbHome表中插入一条记录
