...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    static NSString *strId = @"QYCommentCell";
    QYCommentCell *cell = [tableView dequeueReusableCellWithIdentifier:strId];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"QYCommentCell" owner:nil options:nil] firstObject];
...
- (void)setComment:(QYCommentModel *)comment {
    _comment = comment;
